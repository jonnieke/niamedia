...
values
  (null, 'Real Estate Listing', 'Real Estate', 'Generate property enquiries and site visit bookings', 'Professional',
  ...
  (null, 'Hotel Weekend Offer', 'Hospitality', 'Drive direct bookings and room enquiries', 'Warm',
  ...
  (null, 'School Admissions', 'Education', 'Generate parent enquiries and enrolment applications', 'Professional',
  ...
  (null, 'SACCO / Loan Product', 'Fintech', 'Build trust and drive loan applications', 'Professional',
  ...
  (null, 'Restaurant Daily Offer', 'Restaurant', 'Drive foot traffic, orders, and reservations', 'Friendly',
  ...
  (null, 'Event / Concert Promo', 'Events', 'Sell tickets and drive event registrations', 'Exciting',
  ...
  (null, 'Health & Wellness Clinic', 'Health', 'Generate client bookings and product enquiries', 'Warm',
  ...
  (null, 'Retail Product Launch', 'Retail', 'Drive sales and create urgency around the launch offer', 'Bold',
  ...
  (null, 'Sunday Service Invite', 'Faith & Community', 'Drive attendance and community engagement', 'Warm',
  ...
  (null, 'Professional Services Firm', 'Services', 'Generate enquiries and position as the expert', 'Professional',
