...
const campaignTemplates = [
  { id: 't1', icon: Building2, name: 'Real Estate Listing', industry: 'Real Estate', objective: 'Generate property enquiries and site visit bookings', tone: 'Professional', description: 'Apartments, land, rentals, and property launches. Drives leads, site visits, and enquiries.', platforms: ['Facebook', 'Instagram', 'WhatsApp'], color: '#10b981', to: '/new-campaign' },
  { id: 't2', icon: Hotel, name: 'Hotel Weekend Offer', industry: 'Hospitality', objective: 'Drive direct bookings and room enquiries', tone: 'Warm', description: 'Hotels, Airbnbs, resorts, and travel packages. Built to drive bookings and direct enquiries.', platforms: ['Instagram', 'Facebook', 'WhatsApp'], color: '#3b82f6', to: '/new-campaign' },
  { id: 't3', icon: GraduationCap, name: 'School Admissions', industry: 'Education', objective: 'Generate parent enquiries and enrolment applications', tone: 'Trustworthy', description: 'Schools, tutors, colleges, and edtech platforms. Drives enrolment and parent enquiries.', platforms: ['Facebook', 'WhatsApp', 'LinkedIn'], color: '#f59e0b', to: '/new-campaign' },
  { id: 't4', icon: CreditCard, name: 'Fintech Product', industry: 'Fintech', objective: 'Build trust and drive product applications or sign-ups', tone: 'Professional', description: 'Saccos, loans, insurance, savings, and mobile finance products. Builds trust and drives applications.', platforms: ['Facebook', 'LinkedIn', 'WhatsApp'], color: '#8b5cf6', to: '/new-campaign' },
  { id: 't5', icon: UtensilsCrossed, name: 'Restaurant Offer', industry: 'Restaurant', objective: 'Drive foot traffic, orders, and reservations', tone: 'Friendly', description: 'Food promos, delivery, and lunch offers. High-conversion copy for local food businesses.', platforms: ['Instagram', 'TikTok', 'WhatsApp'], color: '#ef4444', to: '/new-campaign' },
  { id: 't6', icon: Calendar, name: 'Event Promotion', industry: 'Events', objective: 'Sell tickets and drive event registrations', tone: 'Exciting', description: 'Launches, church events, conferences, concerts, and trainings. Drives ticket sales and registrations.', platforms: ['Instagram', 'Facebook', 'WhatsApp'], color: '#06b6d4', to: '/new-campaign' },
  { id: 't7', icon: Heart, name: 'Health & Wellness', industry: 'Health', objective: 'Generate client bookings and product enquiries', tone: 'Warm', description: 'Clinics, gyms, supplement brands, and wellness services. Trust-first copy that converts.', platforms: ['Instagram', 'Facebook', 'WhatsApp'], color: '#ec4899', to: '/new-campaign' },
  { id: 't8', icon: ShoppingBag, name: 'Retail Product Launch', industry: 'Retail', objective: 'Drive sales and create urgency around the launch offer', tone: 'Bold', description: 'New product arrivals, seasonal offers, and clearance sales. Urgency-driven copy for fast results.', platforms: ['Instagram', 'TikTok', 'WhatsApp'], color: '#f97316', to: '/new-campaign' },
  { id: 't9', icon: Briefcase, name: 'Professional Services', industry: 'Services', objective: 'Generate enquiries and position the brand as the expert', tone: 'Professional', description: 'Law firms, accountants, consultants, and agencies. Credibility-first copy for B2B audiences.', platforms: ['LinkedIn', 'Facebook', 'WhatsApp'], color: '#64748b', to: '/new-campaign' },
  { id: 't10', icon: Heart, name: 'Sunday Service Invite', industry: 'Faith & Community', objective: 'Drive attendance and community engagement', tone: 'Warm', description: 'Warm, welcoming copy for weekly services, special Sundays, and sermon series. Drives attendance and community engagement.', platforms: ['WhatsApp', 'Facebook', 'Instagram'], color: '#8b5cf6', to: '/new-campaign' },
  { id: 't11', icon: Heart, name: 'Worship Night / Concert', industry: 'Faith & Community', objective: 'Sell tickets and create excitement for the event', tone: 'Exciting', description: 'High-energy promo for worship events, gospel concerts, and youth nights. Drives registration and tickets.', platforms: ['Instagram', 'Facebook', 'WhatsApp'], color: '#7c3aed', to: '/new-campaign' },
  { id: 't12', icon: Heart, name: 'Fundraising Campaign', industry: 'Faith & Community', objective: 'Inspire donations and community contributions', tone: 'Trustworthy', description: 'Respectful, compelling fundraising copy for community projects, building funds, and outreach programs.', platforms: ['WhatsApp', 'Facebook', 'Instagram'], color: '#059669', to: '/new-campaign' },
  { id: 't13', icon: Heart, name: 'Faith Conference', industry: 'Faith & Community', objective: 'Drive delegate sign-ups and conference registrations', tone: 'Professional', description: 'Registration and awareness copy for conferences, seminars, retreats, and conventions. Drives delegate sign-ups.', platforms: ['Facebook', 'Instagram', 'WhatsApp'], color: '#2563eb', to: '/new-campaign' },
  { id: 't14', icon: Heart, name: 'Community Outreach', industry: 'Faith & Community', objective: 'Recruit volunteers and raise community awareness', tone: 'Warm', description: 'Volunteer recruitment and community awareness copy for outreach programs, food drives, and social impact events.', platforms: ['WhatsApp', 'Facebook', 'Instagram'], color: '#d97706', to: '/new-campaign' },
]
...
function CampaignCard({ t, search }: { t: typeof campaignTemplates[0] & { objective?: string; tone?: string }; search: string }) {
  ...
  const params = new URLSearchParams({ industry: industryParam })
  if (t.objective) params.set('objective', t.objective)
  if (t.tone) params.set('tone', t.tone)
  const toWithParams = `${t.to}?${params.toString()}`
  return (
