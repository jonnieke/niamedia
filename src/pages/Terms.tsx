    ...
    <div className="min-h-screen" style={{ background: '#f1f5f9' }}>
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-sm text-gray-500 leading-relaxed">
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-800 mb-3">2. Services</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-800 mb-3">4. Revisions & Deliverables</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-800 mb-3">5. Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-800 mb-3">6. Refunds & Cancellations</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-800 mb-3">7. User Accounts</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-800 mb-3">8. Prohibited Use</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-800 mb-3">9. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-800 mb-3">10. Governing Law</h2>
            <p>These terms are governed by the laws of Kenya. Any disputes shall be resolved through the courts of Nairobi, Kenya.</p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-gray-800 mb-3">11. Changes to Terms</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-800 mb-3">12. Contact</h2>
