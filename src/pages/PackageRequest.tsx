...
function Form() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    if (error) {
      trackEvent('package_request_submit_failed', { service, timeline: base.timeline, budget: base.budget })
    ...
    trackEvent('package_request_submit_success', { service, timeline: base.timeline, budget: base.budget })
    setSubmitted(true)
    setLoading(false)
  }
