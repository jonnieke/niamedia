    ...
    <div className="min-h-screen" style={{ background: '#f1f5f9' }}>
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-sm text-gray-500 leading-relaxed">
          <section>
            <h2 className="text-base font-semibold text-gray-800 mb-3">1. Who We Are</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-800 mb-3">2. Information We Collect</h2>
            <ul className="space-y-2 list-disc list-inside">
              <li><strong className="text-gray-600">Account data:</strong> name, email address, phone number, and business name provided at registration.</li>
              <li><strong className="text-gray-600">Order data:</strong> campaign briefs, uploaded files, script content, and payment references.</li>
              <li><strong className="text-gray-600">Payment data:</strong> transaction IDs and payment status from PesaPal. We do not store card numbers or M-Pesa PINs.</li>
              <li><strong className="text-gray-600">Usage data:</strong> pages visited, features used, and session duration to improve the platform.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-base font-semibold text-gray-800 mb-3">3. How We Use Your Information</h2>
            <ul className="space-y-2 list-disc list-inside">
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-800 mb-3">6. Cookies</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-800 mb-3">8. Your Rights</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-800 mb-3">9. Children's Privacy</h2>
            <p>Our services are not directed at children under 18. We do not knowingly collect personal data from minors.</p>
          </section>

          <section>
            <h2 className="text-base font-semibold text-gray-800 mb-3">10. Changes to This Policy</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-gray-800 mb-3">11. Contact</h2>
