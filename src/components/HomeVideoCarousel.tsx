...
const CLIENT_VIDEOS: ClientVideoItem[] = [
  ...
  {
    id: 'treasured-artifacts',
    clientName: 'Treasured Artifacts',
    clientRole: 'Amina Hassan, Creative Director',
    industry: 'Luxury Decor & Products',
    title: '3D Cosmic Bottle & Product Showcase',
    ...
    platform: 'Vimeo',
    quote: 'Traditional agencies in Nairobi quoted us KES 250,000 for 3D commercial rendering. Nia Media delivered this luxury cut for a fraction of that in 48 hours.',
